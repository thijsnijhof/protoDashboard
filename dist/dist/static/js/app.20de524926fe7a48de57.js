      ...
      var e = this,
        ...
        ye = ["LocationName", "PinCode", "TimeZone", "ManualOffset", "Timer1", "Timer1-Wake-up-Hour", "Timer1-Wake-up-Min", "Timer1-Sleep-Hour", "Timer1-Sleep-Minutes", "Timer2", "Timer2-Wake-up-Hour", "Timer2-Wake-up-Minutes", "Timer2-Sleep-Hour", "Timer2-Sleep-Minutes", "Auto-Random-Timer-Every", "Auto-Random-After-Interation", "RandomMode", "RandomMode-Hue-Min", "RandomMode-Hue-Max", "Default-Hue", "Default-Harmony", "MasterBrightness", "ColorTemperature", "MaximumSaturation", "MinimumSaturation", "MaximumBrightness", "MinimumBrightness", "EffectMode", "EffectSpeed"];v.a.use(Ne.a);var Te = new Ne.a.Store({ state: { isLoggedIn: !1, accessToken: null, data: {}, singleDevice: {}, singleDeviceData: [], settingsArray: Ce, usrArray: ye, selectedSet: "MSTRSet", singleSetting: [] }, plugins: [Object(we.a)({ storage: { getItem: function getItem(e) {
          ...
          var i = e.commit;new Particle().login({ username: t.username, password: t.password }).then(function (e) {
            console.log("res: ", e.body), i("authUser", { token: e.body.access_token }), Re.push("/home");
          }).catch(function (e) {
            return console.log("failed to login", e);
          });
        }, logout: function logout(e, t) {
          (0, e.commit)("logoutUser", t), Re.push("/");
          ...
          var i = e.commit;console.log("storeSelectedDevice: ", t), i("singleDevice", t), Re.push("/dashboard");
        ...
        } } });v.a.use(d.a);var Re = new d.a({ routes: [{ path: "/home", name: "Home", component: A }, { path: "/", name: "Login", component: O }, { path: "/dashboard", name: "Dashboard", component: ke }] }),
        Ae = { methods: { onLogout: function onLogout() {
          this.$store.dispatch("logout");
        }, onBack: function onBack() {
          "Dashboard" === this.$route.name && Re.push("/home");
        } } },
        Ve = function Ve() {
      var e = this,
          t = e.$createElement,
        ...
        Ee = [],
        Pe = { render: Ve, staticRenderFns: Ee },
        Ie = Pe,
        He = i("VU/8"),
        Le = r,
        $e = He(Ae, Ie, !1, Le, "data-v-100effee", null),
        Be = $e.exports,
        Oe = i("4zzB"),
        We = { name: "app", components: { appHeader: Be, appFooter: Oe.default }, computed: Object(Ne.b)(["isLoggedIn"]) },
        Ue = function Ue() {
      var e = this,
          t = e.$createElement,
        ...
        Fe = [],
        je = { render: Ue, staticRenderFns: Fe },
        Ge = je,
        Ye = i("VU/8"),
        Ze = m,
        ze = Ye(We, Ge, !1, Ze, "data-v-eaa098ec", null),
        qe = ze.exports,
        Xe = i("GS+f"),
        Je = i("oRW0"),
        Ke = i("U0NZ"),
        ...
        ut = i("x6ey"),
        rt = i("OPoU"),
        mt = i("LoEi");v.a.use(Xe.a), v.a.component(Je.a.name, Je.a), v.a.component(Qe.a.name, Qe.a), v.a.component(tt.a.name, tt.a), v.a.component(et.a.name, et.a), v.a.component(it.a.name, it.a), v.a.component(nt.a.name, nt.a), v.a.component(Ke.a.name, Ke.a), v.a.component(at.a.name, at.a), v.a.component(st.a.name, st.a), v.a.component(ot.a.name, ot.a), v.a.component(lt.a.name, lt.a), v.a.component(ct.a.name, ct.a), v.a.component(ut.a.name, ut.a), v.a.component(rt.a.name, rt.a), v.a.component(mt.a.name, mt.a), v.a.config.productionTip = !1, new v.a({ el: "#app", router: Re, store: Te, template: "<App/>", components: { App: qe } });
...
//# sourceMappingURL=app.20de524926fe7a48de57.js.map
//# sourceMappingURL=app.20de524926fe7a48de57.js.map